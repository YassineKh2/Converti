...
import { Download, Monitor, HardDrive, Cpu, MemoryStick, CheckCircle, AlertCircle, Github, Archive } from "lucide-react"
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8 text-pretty max-w-2xl mx-auto">
            Stat converting your files without worrying about their whereabouts. Choose your platform and download the latest
            version.
          </p>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Button variant="outline" className="justify-start h-auto p-4 bg-transparent group">
                  <div className="text-left  ">
                    ...
                    <div className="text-sm text-muted-foreground group-hover:text-white">Download source code</div>
                  </div>
                </Button>
                <Button variant="outline" className="justify-start h-auto p-4 bg-transparent group">
                  <div className="text-left">
                    <div className="font-medium">Previous Versions</div>
                    <div className="text-sm text-muted-foreground group-hover:text-white">Coming soon...</div>
                  </div>
                </Button>
              </div>
            </CardContent>
      ...
      <section id="requirements" className="py-12 px-4 bg-muted/30">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Converti is designed to run efficiently on modern systems</p>
          </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Click the Windows download button above</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-xs font-bold text-accent-foreground">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Double-click the downloaded .exe file</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-xs font-bold text-accent-foreground">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Accept the license and choose install location</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Find it in your Start menu or desktop</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Click the macOS download button above</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-xs font-bold text-accent-foreground">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Double-click to mount the disk image</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-xs font-bold text-accent-foreground">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Drag Converti to your Applications folder</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 mt-0.5 text-green-500" />
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Find Converti in your Applications folder</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Click the Linux download button above</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-xs font-bold text-accent-foreground">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">chmod +x converti-1.0.0-linux-x64.AppImage</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-accent rounded-full flex items-center justify-center text-xs font-bold text-accent-foreground">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Double-click or run from terminal</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 mt-0.5 text-green-500" />
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Converti runs directly from the AppImage</div>
                  </div>
                </div>
              </CardContent>
            </Card>
