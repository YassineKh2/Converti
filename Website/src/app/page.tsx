        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty max-w-2xl mx-auto">
              Transform any file format with complete privacy. No cloud uploads, no data collection, no subscriptions.
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              <Card className="text-center">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">JPG, PNG, GIF, WebP, TIFF, BMP, SVG, HEIC</p>
        ...
        <section id="features" className="py-20 px-4">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">Built with privacy and customization at its core</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="border-2 hover:border-accent/50 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    Your files never leave your computer. No cloud uploads, no servers, no data collection.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card className="border-2 hover:border-accent/50 transition-colors">
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-12">
                In an age of cloud services and data collection, Converti takes a different approach. Your files are
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                <div className="bg-background p-6 rounded-lg border">
                  ...
                  <p className="text-muted-foreground">
                    We don't track, store, or analyze your usage. No analytics, no telemetry, no personal data.
                  </p>
                </div>
                <div className="bg-background p-6 rounded-lg border">
          ...
          <div className="container mx-auto max-w-3xl">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="bg-background border rounded-lg px-6">
                ...
                <AccordionContent>
                  Yes, Converti is completely free with no hidden costs, subscriptions, or premium tiers. All features are
              ...
              <AccordionItem value="item-2" className="bg-background border rounded-lg px-6">
                ...
                <AccordionContent>
                  Converti runs entirely on your computer using your device's processing power. Your files are never
                  uploaded to any server or cloud service. Everything happens locally, ensuring complete privacy and
                  security.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3" className="bg-background border rounded-lg px-6">
                <AccordionTrigger className="text-left">What archive formats are supported?</AccordionTrigger>
                <AccordionContent>
                  Converti supports creating and extracting ZIP, RAR, 7Z, TAR, GZ, BZ2, and XZ archives. You can also
              ...
              <AccordionItem value="item-4" className="bg-background border rounded-lg px-6">
                <AccordionTrigger className="text-left">Can I customize conversion settings?</AccordionTrigger>
                <AccordionContent>
                  Converti offers extensive customization options including quality settings, resolution, compression
                  levels, color profiles, and format-specific parameters. You can save custom presets for repeated use.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-5" className="bg-background border rounded-lg px-6">
                ...
                <AccordionContent>
                  Yes, Converti works completely offline after installation. No internet connection is required for any
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of users who trust Converti for their file conversion needs. Download now and experience the
        ...
        <footer className="border-t bg-muted/30 py-12 px-4">
          <div className="container mx-auto">
            ...
            <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
              <p>&copy; 2025 Converti. All rights reserved. Built with privacy in mind.</p>
            </div>
          </div>
        </footer>
      </div>
